...
export const SettingsSection: React.FC = () => {
  ...
  const resetOnboarding = () => {
    localStorage.removeItem('omnivoice_setup_complete');
              ...
              <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700 space-y-4">
                <div className="flex flex-col space-y-2">
                  ...
                  <p className="text-[10px] text-slate-400">
                    Set OmniVoice as your default Android assistant to activate it by <strong>long-pressing the power button</strong>.
                  </p>
                  <button
